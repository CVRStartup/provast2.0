    ...
    <div className="flex flex-col align-center lg:justify-evenly lg:flex-row my-10 lg:pb-40">
      <div className="mt-48 flex flex-col text-center items-center justify-center xl:w-1/2 lg:mt-0 sm:order-2 lg:order-1 lg:items-start lg:text-left">
        ...
        <p className="text-sm text-white font-base xl:w-3/4">
          ...
          be much easier if they have a favorable view of your CV and cover
          letter.
        </p>
        <div className="flex">
          <button
            type="submit"
            className="mr-2 my-5 py-4 px-4 bg-blue-500 rounded text-white font-bold text-md tracking-wider hover:bg-blue-600"
          >
            Get Started Now
          </button>
          <button
            type="submit"
            className="my-5 py-4 px-4 border rounded text-white font-bold text-md tracking-wider hover:text-blue-500  hover:text-blue-600 hover:border-blue-600"
          >
            Resume Examples
          </button>
        </div>
