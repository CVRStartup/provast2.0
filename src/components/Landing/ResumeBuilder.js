    ...
    <div className="flex flex-col align-center lg:justify-evenly lg:flex-row my-10 lg:pb-40">
      <div className="mt-48 flex flex-col text-center items-center justify-center xl:w-1/2 lg:mt-0 sm:order-1 lg:order-2 lg:items-start lg:text-left">
        ...
        <p className="text-sm font-base xl:w-3/4">
          ...
          3-step resume builder. No more writer’s block or formatting
          difficulties in Word. Rapidly make a perfect resume employers love.
        </p>
        <div className="flex">
          <button
            type="submit"
            className="text-white mr-2 my-5 py-4 px-4 bg-blue-500 rounded font-bold text-md tracking-wider hover:bg-blue-600"
          >
            Create My Resume
          </button>
          <button
            type="submit"
            className="my-5 py-4 px-4 border rounded font-bold text-md tracking-wider hover:text-blue-500  hover:text-blue-600 hover:border-blue-600"
          >
            Resume Examples
          </button>
        </div>
