...
export const Round = ({ type, round, roundIndex, handleRoundChange, handleShortlistFile }) => {
      ...
      <div className='grid grid-cols-2 gap-4 mt-4'>
        <div>
          ...
          <input
            type='datetime-local'
            name='roundDateFrom'
            value={round != null && round.date.from != null ? round.date.from.substring(0, 16) : ""}
            id='roundDateFrom'
        ...
        <div>
          ...
          <input
            ...
            name='roundDateTo'
            id='roundDateTo'
            value={round != null && round.date.to != null ? round.date.to.substring(0, 16) : ""}
