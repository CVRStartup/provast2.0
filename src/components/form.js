...
const Form = ({ isLogin, errorMessage, onSubmit }) => (
  <div className='min-h-[95vh] min-w-full bg-gray-50 flex flex-col items-center justify-center py-12 sm:px-6 lg:px-8'>
          ...
          {isLogin ? (
            <div className='text-sm'>
              ...
              <Link href={"/auth/signup"}>
                <a className='hover:text-gray-900 hover:underline'>Sign up</a>
              </Link>
            </div>
          ) : (
            <div className='text-sm'>
