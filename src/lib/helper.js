...
export const mbaBranches = [
  ...
  { name: "Business Analytics - Human Resource" },
  { name: "Business Analytics - Marketing" },
  { name: "Business Analytics - Operations" },
  ...
  { name: "Operation  - Buisness Analytics" },
  { name: "Operations - Finance" },
  { name: "Operations - Human resource" },
  { name: "Operations - Marketing" },
  { name: "Waste Management - Social Entrepreneurship" },
];
