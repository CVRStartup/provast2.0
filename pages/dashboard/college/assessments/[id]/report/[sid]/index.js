...
const ReportSlug = ({
  ...
  let assessmentMarks = assessmentStatuses.map(
    (assessmentStatus) => assessmentStatus.marks.scored
  );
  ...
  let response_question_ids = new Set(
  ...
  let max_len = sections.reduce(
    (accum, x) => Math.max(accum, x.questions.length),
    0
  );
    ...
    datasets: [
      {
        ...
        data: sectionWiseAttemptedQuestions.map(
          (section) => section.attemptedQuestions
        ),
        ...
        <div className="flex flex-row flex-wrap w-full bg-blue-100 min-h-[300px] border-2 border-solid border-blue-200">
          ...
          <div className="md:w-1/2 flex flex-row items-center justify-center flex-wrap w-full">
            <div className=" bg-green-100 flex flex-col justify-center items-center p-2 m-2 w-[150px] h-[150px] border-2 border-solid border-green-300 rounded shadow">
              ...
              <div className="text-4xl  text-green-900 m-1 font-light">
                {scored}
              </div>
              <div className="text-lg font-light m-1">
                {" "}
                Out of {totalMarks}{" "}
              </div>
            </div>
            <div className="bg-yellow-100 flex flex-col justify-center items-center p-2 m-2 w-[150px] h-[150px] border-yellow-200 border-solid rounded shadow">
              ...
              <div className="text-4xl  text-blue-900 m-1 font-light">
                {percentage}%{" "}
              </div>
            ...
            <div className="bg-red-200 flex flex-col justify-center items-center p-2 m-2 w-[150px] h-[150px] border-2 border-red-300 border-solid rounded shadow">
              ...
              <div className="text-lg font-light m-1">
                {" "}
                Out of {assessmentStatusSet.size}{" "}
              </div>
            </div>
          </div>
        </div>
              ...
              <div className=" flex flex-row flex-wrap w-full md:items-start items-center md:justify-start justify-center">
                <div className="m-5 w-[200px]   flex flex-col border-2 border-solid border-gray-200 rounded shadow px-3 pb-3">
                  ...
                  <div className="flex items-end">
                    <div className="text-blue-500 text-5xl font-light mx-3 my-2">
                      {timeSpentInMinutes}
                    </div>
                    <div className="text-blue-500 text-sm font-bold mx-2 my-2">
                      min
                    </div>
                  </div>
                </div>
...
export const getServerSideProps = async ({ req, res, query }) => {
  ...
  const {
    ...
    `${process.env.HOST_URL}/api/assessments/status?assessmentId=${query.id}`
  );
  ...
  const {
    ...
    `${process.env.HOST_URL}/api/college/students/${query.sid}`
  );
